...
ROOT_URLCONF = 'stock_chart_backend.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],  # You can leave this empty if you are using app directories
...
WSGI_APPLICATION = 'stock_chart_backend.wsgi.application'
